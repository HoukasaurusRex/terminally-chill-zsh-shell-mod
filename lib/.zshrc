...
for file in $HOME/.{path,exports,functions,extra,aliases,bash_profile,bash_prompt}; do
  [ -r "$file" ] && source "$file"
done
unset file
...
# Load syntax highlighting (detect Homebrew prefix for Apple Silicon + Intel)
